...
public class RegionController {
    ...
    @GetMapping(value = "/allCity2")
    @ApiOperation(value = "获取所有的省-市")
    public ResultMessage<List<CityVo>> getAllCity2() {
        List<CityVo> cityVoList = regionService.getAllCity2();
        return ResultUtil.data(cityVoList);
    }
